...
| `app.js` | Toàn bộ logic dashboard, 13 màn hình, đọc dữ liệu từ Supabase. Gồm cả phân quyền, việc giao và phân tích khách hàng |
...
6. Xác nhận `SST` là khách hàng hay mã nội bộ (xem `knowledge/BAN-GIAO.md` mục 9)
